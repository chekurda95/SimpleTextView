...
open class SbisTextViewOrigin : View, SbisTextViewApi {
    ...
    override var text: CharSequence?
        ...
        set(value) {
            configure {
                val transformedText = transformationMethod?.getTransformation(value, this@SbisTextViewOrigin)
    ...
    override var transformationMethod: TransformationMethod? = null
        set(value) {
            ...
            if (isChanged && value != null) {
                ...
                configure { text = value.getTransformation(currentText, this@SbisTextViewOrigin) }
            }
        }
    ...
    override fun setTextAppearance(context: Context, @StyleRes style: Int) {
        ...
        context.withStyledAttributes(attrs = attrs, resourceId = style) {
            ...
            if (linkColorStateList != null) {
                this@SbisTextViewOrigin.linkTextColors = linkColorStateList
            }
            if (allCaps) {
                this@SbisTextViewOrigin.allCaps = true
            }
            when {
                isGone -> Unit
    ...
    private fun obtainAttrs(
        ...
        context.withStyledAttributes(attrs, R.styleable.SbisTextView, defStyleAttr, defStyleRes) {
            ...
            this@SbisTextViewOrigin.linkTextColors = linkColorStateList
            this@SbisTextViewOrigin.isEnabled = isEnabled
            this@SbisTextViewOrigin.gravity = gravity ?: Gravity.NO_GRAVITY
            this@SbisTextViewOrigin.allCaps = allCaps
        }
    }
